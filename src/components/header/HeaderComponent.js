...
import {updateRowData} from "../../store/actions/gridDataActions";
...
const mapStateToProps = (state) => {
    console.log('rawdata in header ',state.rowData);
    //console.log('raw selection in header ',state.rowSelection);
    return {
